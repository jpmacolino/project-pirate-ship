...
- ✅ **Frame mechanics from the bible:** Merfolk (illusion/mind-magic, integrated into society) are the frame-*ee* — a real population to scapegoat, with motive, and mind-magic makes "they lured the ship" believable. "A **recent pattern of lost ships** is the cultural fuel — coastal communities are already uneasy and primed to blame the sea-folk, so the frame catches fast." (Siren dropped: merfolk are a distinct species/faction, not to be conflated with siren folklore.)
